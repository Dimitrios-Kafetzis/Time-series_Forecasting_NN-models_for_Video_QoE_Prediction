...
Description:
    ...
    Updated to work with timeseries_forecasting_models_v6.py which supports
...
Usage Examples:
    Regular mode:
      $ python3 test_models_v6.py --data_folder ./mock_dataset --model_file model_transformer.h5 --seq_length 5 --scaler_file scaler.save

    Testing Linear Regressor model:
      $ python3 test_models_v6.py --data_folder ./mock_dataset --model_file linear_basic.h5 --seq_length 5 --scaler_file scaler.save
      
    Testing Simple DNN model:
      $ python3 test_models_v6.py --data_folder ./mock_dataset --model_file dnn_with_elu.h5 --seq_length 5 --scaler_file scaler.save

    Augmented mode (new format, default):
      $ python3 test_models_v6.py --data_folder ./augmented_dataset --model_file model_lstm.h5 --seq_length 5 --scaler_file scaler.save --augmented

    Augmented mode with extra stats:
      $ python3 test_models_v6.py --data_folder ./augmented_dataset --model_file model_gru.h5 --seq_length 5 --scaler_file scaler.save --augmented --use_stats
"""
