#!/usr/bin/env python3
"""
Filename: validate_models_v6.py
Description:
    ...
    Version 6 includes support for the new model architecture in timeseries_forecasting_models_v6.py.

Usage Examples:
    Validate a single model:
      $ python3 validate_models_v6.py --validation_folder ./validation_dataset --model_file model_lstm.h5 --scaler_file scaler.save --output_dir ./validation_results

    Validate multiple models and create comparison plots:
      $ python3 validate_models_v6.py --validation_folder ./validation_dataset --model_dir ./forecasting_models_v6 --scaler_file scaler.save --output_dir ./validation_results

    Validate models with specific sequence length:
      $ python3 validate_models_v6.py --validation_folder ./validation_dataset --model_dir ./forecasting_models_v6 --scaler_file scaler.save --output_dir ./validation_results --seq_length 5

    Validate models with statistical features enabled:
      $ python3 validate_models_v6.py --validation_folder ./validation_dataset --model_dir ./forecasting_models_v6 --scaler_file scaler.save --output_dir ./validation_results --use_stats
"""
...
try:
    # First try to import from the v6 module
    from timeseries_forecasting_models_v6 import (
    ...
    print(f"Import error from timeseries_forecasting_models_v6: {str(e)}")
    try:
        # Fall back to v5 if v6 is not available
        ...
        try:
            ...
            print("Error: Could not import required functions. Please ensure the files timeseries_forecasting_models_v6.py, timeseries_forecasting_models_v5.py, or test_models.py are in the current directory.")
            sys.exit(1)
...
def main():
    debug_print("Starting validate_models_v6.py script")
